...
Vue.component('search-share', __webpack_require__(35));

Vue.component('trade-share', __webpack_require__(38));
...
Component.options.__file = "/home/rainbow6/www/proj/stock/resources/assets/js/components/SearchShare.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] SearchShare.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-9fc00a6e", Component.options)
  } else {
    hotAPI.reload("data-v-9fc00a6e", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	created: function created() {
		if (this.thislocation) this.location = this.thislocation;
	},


	watch: {
		search_key: function search_key(newval) {
			if (newval) {
				var check = newval.split(' ');
				if (check.length == 1) this.getSuggestion();else {
	...
	methods: {
		getSuggestion: _.debounce(function () {
			...
			var url = "/searchshares/" + this.location + '/' + encodeURIComponent(keys[0]);
			console.log('url is: ');
			console.log(url);
			axios.get(url).then(function (res) {
				if (_typeof(res.data) !== undefined && res.data) {
  ...
  return _c('div', {
    ...
    on: {
      "input": function($event) {
        ...
        _vm.search_key = $event.target.value.trim()
      },
      "blur": function($event) {
        _vm.$forceUpdate()
      }
    ...
    attrs: {
      "hidden": _vm.menuhidden,
      "id": "searchsug"
    }
  }, _vm._l((_vm.suggestions), function(suggest, stockindex) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-9fc00a6e", module.exports)
  }
}
...
Component.options.__file = "/home/rainbow6/www/proj/stock/resources/assets/js/components/TradeShare.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] TradeShare.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-28de9619", Component.options)
  } else {
    hotAPI.reload("data-v-28de9619", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vuejs_countdown__ = __webpack_require__(40);
...
Vue.component('nav-li', {
	...
	created: function created() {
		var vm = this;
		if (this.activeID == this.thisid) this.isActive = 'is-active';

		if (!this.hasBarChart && this.thisid != 'min') this.hide = 'hide';else {
			this.page = 'page';
		}
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	created: function created() {
		...
		if (_typeof(this.predata['unit_in_word'][this.thismarket]) !== undefined && this.predata['unit_in_word'][this.thismarket]) {
		...
		if (this.show_share_chart.indexOf(this.thismarket) < 0) this.hideChart = true;else {
		...
		if (_typeof(this.trading_with_delay[this.thismarket]) !== undefined && parseInt(this.trading_with_delay[this.thismarket]) > 0) {
		...
		//this.isOpened();
		if (_typeof(this.predata.thisshare) !== undefined && this.predata.thisshare) {
			this.hasShare = true;
  ...
  */
	...
	methods: {
		updateshare: function updateshare() {
			var vm = this;
			if (this.thismarket != 'nas' && this.thismarket != 'ny') var fullcode = this.fullcode_prefix[this.thismarket] + this.code;else {
    ...
    **/
		...
		processBtn: function processBtn() {
			...
			if (ifRightCurrency) {
				...
				if (ifHasShare && ifMatchDelay) this.selling_btn_disabled = false;else this.selling_btn_disabled = true;
			} else {
				this.buying_btn_disabled = true;
				this.selling_btn_disabled = true;
			}
		...
		ifRightCurrency: function ifRightCurrency() {
			...
			if (mycurrency == marketcurrency) return true;else return false;
		},

		ifHasShare: function ifHasShare() {
			return parseInt(this.shareAmount) > 0;
		},

		ifHasEnoughMoney: function ifHasEnoughMoney() {
			return parseFloat(this.myself.coins) >= parseFloat(this.current_data.asked_price);
		},

		ifExceedMaxNo: function ifExceedMaxNo() {
		...
		ifMatchDelay: function ifMatchDelay() {
			if (parseInt(this.this_trading_delay) <= 0) return true;else {
				if (this.shareCountdown <= 0) return true;else return false;
			}
		},
  ...
  */
		...
		getShortNum: function getShortNum(num, digits) {
		...
		processChange: function processChange(old, current) {
			if (!old.current_price) return;
			...
			if (current.current_price > old.current_price) this.classData.bigArraowImg = bigUpArrow;else if (current.current_price < old.current_price) this.classData.bigArraowImg = bigDownArrow;else this.classData.bigArraowImg = '';

			this.classData.buyingListPrice = buyingprice;
			this.classData.sellingListPrice = sellingprice;
		},

		changeChart: function changeChart(newActiveId) {
			this.activeID = newActiveId;
			this.chart_img = this.chartImgGet(newActiveId);
			//console.log(this.chart_img);
		},

		chartImgGet: function chartImgGet(type) {
			var code = this.code;
		...
		quick_buy: function quick_buy() {
			...
			if (max_allowed_amount >= parseInt(this.current_data.selling_list_volume1)) actual_amount = parseInt(this.current_data.selling_list_volume1);else actual_amount = max_allowed_amount;
		...
		buy: function buy() {
			...
			var actual_amount, actual_spend;
			actual_amount = actual_spend = 0;
			if (this.buyAmount && this.buyAmount >= parseInt(this.current_data.selling_list_volume1)) actual_amount = parseInt(this.current_data.selling_list_volume1);else if (this.buyAmount && this.buyAmount < parseInt(this.current_data.selling_list_volume1)) actual_amount = this.buyAmount;else {
				//this.buying_btn_disabled = true;
				var title = '错误';
		...
		quick_sell: function quick_sell() {
			...
			if (max_allowed_amount >= parseInt(this.current_data.buying_list_volume1)) actual_amount = parseInt(this.current_data.buying_list_volume1);else max_allowed_amount < parseInt(this.current_data.buying_list_volume1);
		...
		sell: function sell() {
			...
			if (this.sellAmount && this.sellAmount >= parseInt(this.current_data.buying_list_volume1)) actual_amount = parseInt(this.current_data.buying_list_volume1);else if (this.sellAmount && this.sellAmount < parseInt(this.current_data.buying_list_volume1)) actual_amount = this.sellAmount;else {
				//this.buying_btn_disabled = true;
				var title = '错误';
		...
		ajax_buy: function ajax_buy(sid, iid, amount, price) {
			var vm = this;
      ...
      */
		...
		ajax_sell: function ajax_sell(sid, iid, amount, price) {
			var vm = this;
			//var baseURL = 'http://stock.yucheung.com/';
			var baseURL = '/';
      ...
      */
						...
						if (parseFloat(net_gain) < 0) gain_msg += '净亏' + vm.currency[vm.myself.bind_to]['name'] + ' ' + Math.abs(parseFloat(net_gain)) + '.';else if (parseFloat(net_gain) > 0) gain_msg += '净赚' + vm.currency[vm.myself.bind_to]['name'] + ' ' + Math.abs(parseFloat(net_gain)) + '.';
		...
		showconfirm: function showconfirm(title, msg) {
...
Component.options.__file = "/home/rainbow6/www/proj/stock/node_modules/vuejs-countdown/Countdown.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4bb429d7", Component.options)
  } else {
    hotAPI.reload("data-v-4bb429d7", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var update = __webpack_require__(44)("0f0434d3", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../css-loader/index.js!../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4bb429d7\",\"scoped\":false,\"hasInlineConfig\":true}!../vue-loader/lib/selector.js?type=styles&index=0!./Countdown.vue", function() {
     var newContent = require("!!../css-loader/index.js!../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4bb429d7\",\"scoped\":false,\"hasInlineConfig\":true}!../vue-loader/lib/selector.js?type=styles&index=0!./Countdown.vue");
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.filter('twoDigits', function (value) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('ul', {
    ...
    staticClass: "digit"
  }, [_vm._v(_vm._s(_vm._f("twoDigits")(_vm.days)))]), _vm._v(" "), _c('p', {
    staticClass: "text"
  }, [_vm._v("days")])]), _vm._v(" "), _c('li', [_c('p', {
    staticClass: "digit"
  }, [_vm._v(_vm._s(_vm._f("twoDigits")(_vm.hours)))]), _vm._v(" "), _c('p', {
    staticClass: "text"
  }, [_vm._v("hours")])]), _vm._v(" "), _c('li', [_c('p', {
    staticClass: "digit"
  }, [_vm._v(_vm._s(_vm._f("twoDigits")(_vm.minutes)))]), _vm._v(" "), _c('p', {
    staticClass: "text"
  }, [_vm._v("Min")])]), _vm._v(" "), _c('li', [_c('p', {
    staticClass: "digit"
  }, [_vm._v(_vm._s(_vm._f("twoDigits")(_vm.seconds)))]), _vm._v(" "), _c('p', {
    staticClass: "text"
  }, [_vm._v("Sec")])])])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-4bb429d7", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "title"
  }, [_vm._v(_vm._s(_vm.sharename) + "交易平台")]), _vm._v(" "), _c('hr'), _vm._v(" "), _c('div', {
    staticClass: "tile is-ancestor is-vertical"
  }, [_vm._m(0), _vm._v(" "), _c('div', {
    staticClass: "tile"
  }, [_c('section', {
    staticClass: "tile is-6 is-parent is-vertical"
  }, [_c('section', {
    ...
    class: [_vm.classData.priceChange],
    attrs: {
      "id": "current-price"
    }
  }, [_vm._v(_vm._s(_vm.current_data.current_price))])]), _vm._v(" "), _c('div', {
    class: [_vm.classData.bigArraowImg]
  })]), _vm._v(" "), _c('div', {
    staticClass: "tile"
  }, [_c('div', {
    staticClass: "share-change"
  }, [_c('span', {
    class: [_vm.classData.TextPos, _vm.classData.priceChange],
    attrs: {
      "id": "share-change-in-price"
    }
  }, [_vm._v(_vm._s(_vm.current_data.change_in_price))]), _vm._v(" "), _c('span', {
    class: [_vm.classData.TextPos, _vm.classData.priceChange],
    attrs: {
      "id": "share-change-in-percent"
    }
  }, [_vm._v(_vm._s(_vm.current_data.change_in_percent) + "%")])])])]), _vm._v(" "), _c('hr'), _vm._v(" "), _c('div', {
    staticClass: "tile"
  }, [_c('div', {
    staticClass: "share-index-ext"
  }, [_c('div', [_c('span', {
    staticClass: "share-detail-title"
  }, [_vm._v("涨停:")]), _vm._v(" "), _c('span', {
    class: [_vm.classData.TextPos, _vm.classData.shareDetailValue],
    attrs: {
      "id": "max-price"
    }
  }, [_vm._v(_vm._s(_vm.current_data.max_price))])]), _vm._v(" "), _c('div', [_c('span', {
    staticClass: "share-detail-title"
  }, [_vm._v("跌停:")]), _vm._v(" "), _c('span', {
    class: [_vm.classData.TextPos, _vm.classData.shareDetailValue],
    attrs: {
      "id": "min-price"
    }
  }, [_vm._v(_vm._s(_vm.current_data.min_price))])])])])]), _vm._v(" "), _c('div', {
    staticClass: "tile"
  }, [_c('table', {
    staticClass: "stock-price-detail"
  }, [_c('tr', [_c('td', [_c('span', {
    staticClass: "share-detail-title"
  }, [_vm._v("今开:")]), _vm._v(" "), _c('span', {
    class: [_vm.classData.openingpriceChange],
    attrs: {
      "id": "opening-price"
    }
  }, [_vm._v(_vm._s(_vm.current_data.opening_price))])]), _vm._v(" "), _c('td', [_c('span', {
    staticClass: "share-detail-title"
  }, [_vm._v("成交量:")]), _vm._v(" "), _c('span', {
    class: [_vm.classData.shareDetailValue],
    attrs: {
      "id": "trading-volume"
    }
  }, [_vm._v(_vm._s(_vm.current_data.trade_volume))]), _vm._v(" "), _c('span', {
    staticClass: "share-detail-value"
  }, [_vm._v(_vm._s(_vm.current_data.unit_in_volume))]), _c('span', {
    staticClass: "share-detail-value"
  }, [_vm._v(_vm._s(_vm.current_data.unit_in_word))])])]), _vm._v(" "), _c('tr', [_c('td', [_c('span', {
    staticClass: "share-detail-title"
  }, [_vm._v("竞买:")]), _vm._v(" "), _c('span', {
    class: [_vm.classData.bidpriceChange],
    attrs: {
      "id": "bid-price"
    }
  }, [_vm._v(_vm._s(_vm.current_data.bid_price))])]), _vm._v(" "), _c('td', [_c('span', {
    staticClass: "share-detail-title"
  }, [_vm._v("竞卖:")]), _vm._v(" "), _c('span', {
    class: [_vm.classData.askedpriceChange],
    attrs: {
      "id": "asked-price"
    }
  }, [_vm._v(_vm._s(_vm.current_data.asked_price))])])]), _vm._v(" "), _c('tr', [_c('td', [_c('span', {
    staticClass: "share-detail-title"
  }, [_vm._v("最高:")]), _vm._v(" "), _c('span', {
    class: [_vm.classData.highestpriceChange],
    attrs: {
      "id": "highest-price"
    }
  }, [_vm._v(_vm._s(_vm.current_data.highest_price))])]), _vm._v(" "), _c('td', [_c('span', {
    staticClass: "share-detail-title"
  }, [_vm._v("成交额:")]), _vm._v(" "), _c('span', {
    staticClass: "share-detail-value",
    attrs: {
      "id": "trading-amount"
    }
  }, [_vm._v(_vm._s(_vm.current_data.trade_amount))]), _vm._v(" "), _c('span', {
    staticClass: "share-detail-value"
  }, [_vm._v(_vm._s(_vm.current_data.unit_in_amount))])])]), _vm._v(" "), _c('tr', [_c('td', [_c('span', {
    staticClass: "share-detail-title"
  }, [_vm._v("最低:")]), _vm._v(" "), _c('span', {
    class: [_vm.classData.lowestpriceChange],
    attrs: {
      "id": "lowest-price"
    }
  }, [_vm._v(_vm._s(_vm.current_data.lowest_price))])]), _vm._v(" "), _c('td', [_c('span', {
    staticClass: "share-detail-title"
  }, [_vm._v("昨收:")]), _vm._v(" "), _c('span', {
    staticClass: "closing-price-value",
    attrs: {
      "id": "closing-price"
    }
  }, [_vm._v(_vm._s(_vm.current_data.closing_price))])])])])])]), _vm._v(" "), (_vm.hideChart == false) ? [_c('section', {
    staticClass: "tile is-child box"
  }, [(_vm.hasBarChart) ? _c('nav', {
    staticClass: "breadcrumb is-centered",
    attrs: {
      "aria-label": "大盘指数",
      "id": "chart-nav"
    }
    ...
    attrs: {
      "thismarket": _vm.thismarket,
      "activeID": _vm.activeID,
      "hasBarChart": _vm.hasBarChart,
      "thisname": "分时线",
      "thisid": "min"
    },
    on: {
      "changeChart": _vm.changeChart
    }
  }), _vm._v(" "), _c('nav-li', {
    attrs: {
      "thismarket": _vm.thismarket,
  ...
  })], 1)]) : _vm._e(), _vm._v(" "), _c('figure', {
    staticClass: "image is-545*300",
    attrs: {
      "id": "chart"
    }
  }, [_c('img', {
    ...
    staticClass: "stock-trade-detail"
  }, [_vm._m(1), _vm._v(" "), _c('tr'), _vm._v(" "), _c('tr', [_vm._m(2), _vm._v(" "), _c('td', [_c('span', {
    class: [_vm.classData.shareDetailValue, _vm.classData.buyingListPrice],
    attrs: {
      "id": "buyinglist-1-price"
    }
  }, [_vm._v(_vm._s(_vm.current_data.buying_list_price1))])]), _vm._v(" "), _c('td', [_c('span', {
    staticClass: "share-detail-value",
    attrs: {
      "id": "buyinglist-1-volume"
    }
  }, [_vm._v(_vm._s(_vm.current_data.buying_list_volume1))])]), _vm._v(" "), _vm._m(3), _vm._v(" "), _c('td', [_c('span', {
    class: [_vm.classData.shareDetailValue, _vm.classData.sellingListPrice],
    attrs: {
      "id": "sellinglist-1-price"
    }
  }, [_vm._v(_vm._s(_vm.current_data.selling_list_price1))])]), _vm._v(" "), _c('td', [_c('span', {
    staticClass: "share-detail-value",
    attrs: {
      "id": "sellinglist-1-volume"
    }
  }, [_vm._v(_vm._s(_vm.current_data.selling_list_volume1))])])]), _vm._v(" "), _c('tr', [_vm._m(4), _vm._v(" "), _c('td', [_c('span', {
    class: [_vm.classData.shareDetailValue, _vm.classData.buyingListPrice],
    attrs: {
      "id": "buyinglist-2-price"
    }
  }, [_vm._v(_vm._s(_vm.current_data.buying_list_price2))])]), _vm._v(" "), _c('td', [_c('span', {
    staticClass: "share-detail-value",
    attrs: {
      "id": "buyinglist-2-volume"
    }
  }, [_vm._v(_vm._s(_vm.current_data.buying_list_volume2))])]), _vm._v(" "), _vm._m(5), _vm._v(" "), _c('td', [_c('span', {
    class: [_vm.classData.shareDetailValue, _vm.classData.sellingListPrice],
    attrs: {
      "id": "sellinglist-2-price"
    }
  }, [_vm._v(_vm._s(_vm.current_data.selling_list_price2))])]), _vm._v(" "), _c('td', [_c('span', {
    staticClass: "share-detail-value",
    attrs: {
      "id": "sellinglist-2-volume"
    }
  }, [_vm._v(_vm._s(_vm.current_data.selling_list_volume2))])])]), _vm._v(" "), _c('tr', [_vm._m(6), _vm._v(" "), _c('td', [_c('span', {
    class: [_vm.classData.shareDetailValue, _vm.classData.buyingListPrice],
    attrs: {
      "id": "buyinglist-3-price"
    }
  }, [_vm._v(_vm._s(_vm.current_data.buying_list_price3))])]), _vm._v(" "), _c('td', [_c('span', {
    staticClass: "share-detail-value",
    attrs: {
      "id": "buyinglist-3-volume"
    }
  }, [_vm._v(_vm._s(_vm.current_data.buying_list_volume3))])]), _vm._v(" "), _vm._m(7), _vm._v(" "), _c('td', [_c('span', {
    class: [_vm.classData.shareDetailValue, _vm.classData.sellingListPrice],
    attrs: {
      "id": "sellinglist-3-price"
    }
  }, [_vm._v(_vm._s(_vm.current_data.selling_list_price3))])]), _vm._v(" "), _c('td', [_c('span', {
    staticClass: "share-detail-value",
    attrs: {
      "id": "sellinglist-3-volume"
    }
  }, [_vm._v(_vm._s(_vm.current_data.selling_list_volume3))])])]), _vm._v(" "), _c('tr', [_vm._m(8), _vm._v(" "), _c('td', [_c('span', {
    class: [_vm.classData.shareDetailValue, _vm.classData.buyingListPrice],
    attrs: {
      "id": "buyinglist-4-price"
    }
  }, [_vm._v(_vm._s(_vm.current_data.buying_list_price4))])]), _vm._v(" "), _c('td', [_c('span', {
    staticClass: "share-detail-value",
    attrs: {
      "id": "buyinglist-4-volume"
    }
  }, [_vm._v(_vm._s(_vm.current_data.buying_list_volume4))])]), _vm._v(" "), _vm._m(9), _vm._v(" "), _c('td', [_c('span', {
    class: [_vm.classData.shareDetailValue, _vm.classData.sellingListPrice],
    attrs: {
      "id": "sellinglist-4-price"
    }
  }, [_vm._v(_vm._s(_vm.current_data.selling_list_price4))])]), _vm._v(" "), _c('td', [_c('span', {
    staticClass: "share-detail-value",
    attrs: {
      "id": "sellinglist-4-volume"
    }
  }, [_vm._v(_vm._s(_vm.current_data.selling_list_volume4))])])]), _vm._v(" "), _c('tr', [_vm._m(10), _vm._v(" "), _c('td', [_c('span', {
    class: [_vm.classData.shareDetailValue, _vm.classData.buyingListPrice],
    attrs: {
      "id": "buyinglist-5-price"
    }
  }, [_vm._v(_vm._s(_vm.current_data.buying_list_price5))])]), _vm._v(" "), _c('td', [_c('span', {
    staticClass: "share-detail-value",
    attrs: {
      "id": "buyinglist-5-volume"
    }
  }, [_vm._v(_vm._s(_vm.current_data.buying_list_volume5))])]), _vm._v(" "), _vm._m(11), _vm._v(" "), _c('td', [_c('span', {
    class: [_vm.classData.shareDetailValue, _vm.classData.sellingListPrice],
    attrs: {
      "id": "sellinglist-5-price"
    }
  }, [_vm._v(_vm._s(_vm.current_data.selling_list_price5))])]), _vm._v(" "), _c('td', [_c('span', {
    staticClass: "share-detail-value",
    attrs: {
      "id": "sellinglist-5-volume"
    }
  }, [_vm._v(_vm._s(_vm.current_data.selling_list_volume5))])])])])]), _vm._v(" "), _c('section', {
    staticClass: "tile is-child box"
  }, [_c('form', {
    attrs: {
      "id": "trading-form"
    ...
    attrs: {
      "disabled": _vm.buying_btn_disabled
    },
    on: {
      "click": _vm.quick_buy
    }
  }, [_c('span', [_vm._v("快速买入")]), _vm._v(" "), _vm._m(12)])]), _vm._v(" "), _c('div', {
    staticClass: "control"
  }, [_c('div', {
    staticClass: "field has-addons"
  }, [_c('div', {
  ...
  }, [_c('span', [_vm._v("买入")]), _vm._v(" "), _vm._m(13)])]), _vm._v(" "), _c('div', {
    staticClass: "control has-icons-left"
  }, [_c('input', {
    directives: [{
      name: "model",
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.buyAmount = $event.target.value
      }
    }
    ...
    staticClass: "button is-success",
    attrs: {
      "disabled": _vm.selling_btn_disabled
    },
    on: {
      "click": _vm.quick_sell
    }
  }, [_c('span', [_vm._v("快速卖出")]), _vm._v(" "), _vm._m(15)])]), _vm._v(" "), _c('div', {
    staticClass: "control"
  }, [_c('div', {
    staticClass: "field has-addons"
  }, [_c('div', {
  ...
  }, [_c('span', [_vm._v("卖出")]), _vm._v(" "), _vm._m(16)])]), _vm._v(" "), _c('div', {
    staticClass: "control has-icons-left"
  }, [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.sellAmount),
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.sellAmount = $event.target.value
      }
    }
    ...
    staticClass: "avatar-medium",
    style: ({
      'background-image': 'url(' + _vm.avator_url + ')'
    })
  })]), _vm._v(" "), _c('div', {
    ...
    staticClass: "info-element"
  }, [_c('span', {
    staticClass: "info-title"
  }, [_vm._v("现金：")]), _c('span', {
    staticClass: "info-detail"
  }, [_vm._v(_vm._s(_vm.myself.coins))])]), _vm._v(" "), _c('div', {
    staticClass: "info-element"
  }, [_c('span', {
    staticClass: "info-title"
  }, [_vm._v("货币：")]), _c('span', {
    staticClass: "info-detail"
  }, [_vm._v(_vm._s(_vm.currency[_vm.myself.bind_to]['name']))])]), _vm._v(" "), _c('div', {
    staticClass: "info-element"
  }, [_c('span', {
    staticClass: "info-title"
  }, [_vm._v("拥股数：")]), _c('span', {
    staticClass: "info-detail"
  }, [_vm._v(_vm._s(_vm.shareCount))])]), _vm._v(" "), _c('hr'), _vm._v(" "), _c('div', {
    staticClass: "info-element"
  }, [_c('span', {
    staticClass: "info-title"
  }, [_vm._v("拥股量：")]), _c('span', {
    staticClass: "info-detail"
  }, [_vm._v(_vm._s(_vm.shareAmount))])]), _vm._v(" "), _c('div', {
    staticClass: "info-element"
  }, [_c('span', {
    staticClass: "info-title"
  }, [_vm._v("买入价：")]), _c('span', {
    staticClass: "info-detail"
  }, [_vm._v(_vm._s(_vm.buyingPrice))])]), _vm._v(" "), _c('div', {
    staticClass: "info-element"
  }, [_c('span', {
    staticClass: "info-title"
  }, [_vm._v("卖出价：")]), _c('span', {
    staticClass: "info-detail"
  }, [_vm._v(_vm._s(_vm.sellingPrice))])])])])])])])])])])]), _vm._v(" "), _c('div', {
    staticClass: "inactivo",
    attrs: {
      "id": "confirm-dialog",
      "title": _vm.msg_title
    }
  }, [_c('p', [_vm._v(_vm._s(_vm.post_trade_msg))])])])
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "tile has-text-right"
  }, [_c('div', {
    staticClass: "clock"
  })])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('tr', [_c('th'), _vm._v(" "), _c('th', [_vm._v("买方")]), _vm._v(" "), _c('th'), _vm._v(" "), _c('th'), _vm._v(" "), _c('th', [_vm._v("卖方")]), _vm._v(" "), _c('th')])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-28de9619", module.exports)
  }
}
